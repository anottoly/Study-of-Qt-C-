/****************************************************************************
** Meta object code from reading C++ file 'errorwidget.h'
**
...
#include <memory>
#include "../../../userEmulator/errorwidget.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'errorwidget.h' doesn't include <QObject>."
...
QT_INIT_METAOBJECT const QMetaObject ErrorWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_ErrorWidget.data,
    qt_meta_data_ErrorWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
